...
imgElonTest = face_recognition.load_image_file('images/elon.jpg')
...
cv2.putText(imgElonTest,f'{result}, {round(faceDis[0],2)}', (50,50),cv2.FONT_HERSHEY_COMPLEX,1,(255,0,0),2)
